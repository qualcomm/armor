...
typedef struct {
    ...
    typedef struct {
        ...
        int month;
        int day;
    } *********const****volatile*****manufactureDate[30];
...
typedef struct {
    ...
    } volatile**********const*********systemDetails[10];

} System;

typedef struct DALSYSPropertyVar DALSYSPropertyVar1;
...
typedef union
{
 ...
 __CL_ANON_STRUCT__ struct{ char s2, s3; };
 __CL_ANON_STRUCT__ struct{ char lo, hi; };
}cl_uchar4;
